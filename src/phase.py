...
def _ollama_alive(base_url: str) -> bool:
    """Thin alias kept for the existing call sites and tests.

    The probe itself lives in `ollama_supervisor`, which owns bringing Ollama
    up as well as asking whether it is up.
    """
    return ollama_supervisor.is_alive(base_url)
